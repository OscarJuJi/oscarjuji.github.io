...
/**
 * Inline SVG icons (replacing the old emojis) so they scale crisply and
 * inherit the current text color — automatically theme-aware.
 * Sources: Bootstrap Icons v1.11.3 (MIT) and Tabler Icons v3 (MIT).
 */
...
export const BriefcaseIcon = ({ size = 16 }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} fill="currentColor" viewBox="0 0 16 16" aria-hidden="true">
